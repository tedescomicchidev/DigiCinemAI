...
builder.Services.AddSingleton<DistributionAgentHandler>();
builder.Services.AddHostedService<AgentWorker<DistributionAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "DistributionAgent", status = "ready" }));
