...
builder.Services.AddSingleton<FactCheckAgentHandler>();
builder.Services.AddHostedService<AgentWorker<FactCheckAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "FactCheckAgent", status = "ready" }));
