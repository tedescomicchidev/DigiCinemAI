...
builder.Services.AddSingleton<SeoPackagingAgentHandler>();
builder.Services.AddHostedService<AgentWorker<SeoPackagingAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "SEOPackagingAgent", status = "ready" }));
