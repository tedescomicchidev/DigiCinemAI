...
builder.Services.AddSingleton<PitchAgentHandler>();
builder.Services.AddHostedService<AgentWorker<PitchAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "PitchAgent", status = "ready" }));
