...
builder.Services.AddSingleton<CopyEditAgentHandler>();
builder.Services.AddHostedService<AgentWorker<CopyEditAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "CopyEditAgent", status = "ready" }));
