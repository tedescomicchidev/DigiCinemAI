...
builder.Services.AddSingleton<AnalyticsAgentHandler>();
builder.Services.AddHostedService<AgentWorker<AnalyticsAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "AnalyticsAgent", status = "ready" }));
