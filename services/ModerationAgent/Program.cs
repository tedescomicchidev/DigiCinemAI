...
builder.Services.AddSingleton<ModerationAgentHandler>();
builder.Services.AddHostedService<AgentWorker<ModerationAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "ModerationAgent", status = "ready" }));
