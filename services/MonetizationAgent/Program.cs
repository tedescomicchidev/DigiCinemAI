...
builder.Services.AddSingleton<MonetizationAgentHandler>();
builder.Services.AddHostedService<AgentWorker<MonetizationAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "MonetizationAgent", status = "ready" }));
