...
builder.Services.AddSingleton<RecirculationService>();
builder.Services.AddSingleton<ReporterAgentHandler>();
builder.Services.AddHostedService<AgentWorker<ReporterAgentHandler>>();
...
app.MapGet("/", () => Results.Ok(new { service = "ReporterAgent", status = "ready" }));
